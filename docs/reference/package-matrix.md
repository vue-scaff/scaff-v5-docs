...
| `@scaff/data` | `5.0.0-alpha.0` | Request Client、Service 与 Store 依赖注入 | 按需使用；Vue 默认模板已安装 |
| `@scaff/create` | `5.0.0-alpha.11` | 交互式创建 Vue、React 或 Core 项目 | 仅创建项目时使用 |
...
|---|---|---|
| Vue | `@scaff/core`、`@scaff/data`、`@scaff/vue`、`@scaff/utils`、`vue` | `@scaff/vite`、Vite、Vue Vite 插件、TypeScript |
